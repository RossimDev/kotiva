...
export const Route = createFileRoute("/terms")({
  head: () => ({
    meta: [
      { title: "Termos de Uso — SmartFridge AI" },
      { name: "description", content: "Termos e condições para uso do SmartFridge AI." },
      { property: "og:title", content: "Termos de Uso" },
      { property: "og:description", content: "Condições de uso da plataforma SmartFridge AI." },
    ],
  }),
  component: Terms,
});
  ...
  return (
    <article className="mx-auto max-w-3xl px-4 py-16 sm:px-6">
      ...
      <div className="mt-8 space-y-6 text-muted-foreground">
        <section><h2 className="font-display text-2xl font-bold text-foreground">1. Aceitação</h2><p>Ao usar o SmartFridge AI, você concorda com estes termos.</p></section>
